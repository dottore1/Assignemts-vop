 ...
 * @author erso
 */
public class DanishIslandsFileReader {

    private File inFile;
    private List<DanishIslands> islandList;

    public DanishIslandsFileReader(String fName) {
        inFile = new File(fName);
    }

    private void readFile() {
        islandList = new ArrayList<DanishIslands>();
        Scanner scan = null;
        String line;
        String[] tokens;
        ...
        try {
            ...
            while (scan.hasNextLine()) {
                ...
                islandList.add(new DanishIslands(name, circ, area, addr, adkm));
            }
            scan.close();
            ...
            Logger.getLogger(DanishIslandsFileReader.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String[] args) {
        ...
        DanishIslandsFileReader fr = new DanishIslandsFileReader("Islands punktum.txt");
